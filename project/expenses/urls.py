...
from .views import category_home, expenses_home, category_page, userSignup, userLogin, forgot_password, verify_otp, reset_password, success_password_reset, userLogout, userHomePage, add_user_expenses
urlpatterns = [
